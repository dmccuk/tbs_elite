...
import {
  V, box, std, lit, decal, panelMat, add, zCyl, planform, profile, Y_UP, rod, light, group,
  bakeParts, addParts, flasher, canvasTex, hazardMat, scorchMat, lazy,
} from "./model-kit";

/** Ship-specific: the dark ring inside an engine nozzle. */
