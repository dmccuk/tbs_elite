  ...
  <body>
    ...
    <div id="hud">
      ...
      <div id="status-panel">
        ...
        <div class="data">
          ...
          <div style="margin-top: 8px; font-size: 11px; opacity: 0.7;">
            <div>Planet: 6,400km radius</div>
            <div>Station: Vigilant Relay</div>
          </div>
        </div>
      </div>
      ...
      <div id="controls">
        ...
        <span class="key">F</span> Flight Assist
        <span class="key">J</span> Supercruise
      </div>
      ...
      <div id="target-info">
        ...
        <div class="target-data">
          <div>Distance: <span id="target-dist">0</span></div>
          <div>Type: Orbital Station</div>
          <div>Orbit: 400km from planet</div>
